...
import com.openclassrooms.realestatemanager.ui.property.browse.detail.view.PhotoDetailDialogFragment
        ...
        PhotoDetailAdapter.OnItemClickListener
{
    ...
    fun showDetails(propertyId: String?) {
        ...
        PhotoDetailAdapter().apply {
            ...
            setOnItemClickListener(this@DetailFragment)
        ...
        when (item.itemId) {
            R.id.navigation_edit -> {
                ...
                if(masterDetailFragment.detail.childFragmentManager
                    ...
                    val updateFragment: UpdateFragment = masterDetailFragment.detail.childFragmentManager
                        .findFragmentByTag(R.id.navigation_edit.toString()) as UpdateFragment

                    val propertyId = property.id
                    updateFragment.showDetails(propertyId)
