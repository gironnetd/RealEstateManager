...
public class BrowseMasterFragmentNavigator extends Navigator<androidx.navigation.fragment.FragmentNavigator.Destination> {
    ...
    public BrowseMasterFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                                         int containerId) {
        mContext = context;
